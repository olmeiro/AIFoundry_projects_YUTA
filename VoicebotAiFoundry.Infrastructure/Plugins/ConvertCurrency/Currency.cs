namespace VoicebotAiFoundry.Infrastructure.Plugins.ConvertCurrency.AITravelAgent;
...
public class Currency
{
    ...
    public static void InitializeCurrencies()
    {
        ...
        "..", "VoicebotAiFoundry.Infrastructure", "Plugins", "ConvertCurrency", "currencies.txt"
    );
        ...
        {
            throw new FileNotFoundException($"Couldn't find currencies.txt at {filePath}");
        }
